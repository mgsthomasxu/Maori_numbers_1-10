"""Maori_N
Removed unnecessary else condition in the check_answer function for simpler code.
Moved the number of questions to a variable num_questions to make it easier to
modify the number of questions asked in the quiz."""
